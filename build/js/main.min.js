...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var membershipsPeriodList = document.querySelector('.memberships__period-list');
  var membershipsPeriodArray = membershipsPeriodList.querySelectorAll('li');
  var membershipsTypeListArray = document.querySelectorAll('.memberships__type-list');
  membershipsPeriodList.style.display = 'flex';
  var showMembershipsTypeList = function showMembershipsTypeList() {
    for (var i = 0; membershipsPeriodArray.length > i; i++) {
  ...
  var _loop = function _loop(i) {
    var onPeriodClick = function onPeriodClick() {
      for (var _j = 0; membershipsPeriodArray.length > _j; _j++) {
        if (i === _j) {
          membershipsPeriodArray[_j].classList.add('memberships__period-item--active');
        } else {
          membershipsPeriodArray[_j].classList.remove('memberships__period-item--active');
        }
      }
      showMembershipsTypeList();
    };
  ...
  for (var j = 0; membershipsTypeListArray.length > j; j++) {
    var membershipsCardsArray = membershipsTypeListArray[j].querySelectorAll('li');
    for (var _i = 0; membershipsCardsArray.length > _i; _i++) {
      var price = membershipsCardsArray[_i].querySelector('p');
      var priceValue = price.textContent;
      var priceShadow = document.createElement('span');
      var priceField = membershipsCardsArray[_i].querySelector('.memberships-card__price');
